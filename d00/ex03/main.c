...
int main(void)
{
    ...
    printf("price for the art \'%s\' is %d\n", "Night Watch", searchPrice(dict, "Night Watch"));
    printf("price for the art \'%s\' is %d\n", "Guernica", searchPrice(dict, "Guernica"));
	printf("price for the art \'%s\' is %d\n", "O greatest show of worth from circus alphabet", searchPrice(dict, "O greatest show of worth from circus alphabet"));
	printf("price for the art \'%s\' is %d\n", "I dont exist", searchPrice(dict, "I dont exist"));
