...
int main(void)
{
	...
	printf("price for the art \'%s\' is %d\n", "O greatest show of worth from circus alphabet", searchPrice(arts, n, "O greatest show of worth from circus alphabet"));
	printf("price for the art \'%s\' is %d\n", "I dont exist", searchPrice(arts, n, "I dont exist"));
